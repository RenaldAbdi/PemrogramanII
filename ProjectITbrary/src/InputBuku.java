...
public class InputBuku extends javax.swing.JFrame {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        int tahunvalid = Integer.parseInt(txtTahun.getText());
        ...
        } else if(tahunvalid > 2022 | tahunvalid < 1970){
            JOptionPane.showMessageDialog(this,"Tahun yang diinputkan hanya bisa dari tahun 1970 - Sekarang!");
